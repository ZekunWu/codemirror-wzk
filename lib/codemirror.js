...
(function (global, factory) {
  ...
  function buildLineContent(cm, lineView, lineN) {
    if ( lineN === void 0 ) lineN = -1;
   //wzkfix
  ...
  function buildLineElement(cm, lineView, lineN, dims) {
    var built = getLineContent(cm, lineView, lineN); //wzkfix
  ...
  Doc.prototype = createObj(BranchChunk.prototype, {
    ...
    makeChange: makeChange, //wzkfix new
  ...
  var commands = {
    ...
    newlineAndIndent: function (cm) { return runInOp(cm, function () {
      ...
      if(cm.options.lockedLines) { cm.options.lockedLines = cm.options.lockedLines.map(function (item) {  //wzkfix
  ...
  function addEditorMethods(CodeMirror) {
    ...
    CodeMirror.prototype = {
      ...
      deleteH: methodOp(function(dir, unit, cm) {
        if ( cm === void 0 ) cm=this;
   //wzkfix
        ...
        if (sel.somethingSelected())
            ...
            { deleteNearSelection(this, function (range$$1) {
              ...
              if(other.line < range$$1.head.line){
                if(cm.options.lockedLines) { cm.options.lockedLines = cm.options.lockedLines.map(function (item) {
